...
# PURPOSE:
#    Create a function calculates_results_stats that calculates the statistics 
#    of the results of the program run using the classifier's model 
#    architecture to classify the images. 
#
#    This function will use the results in the results dictionary to calculate 
#    these statistics. 
...
#    Please see "Intro to Python - Project classifying Images - xx Calculating 
#    Results" for details on the how to calculate the counts and 
...
def calculates_results_stats(results_dic):
    ...
    Then puts the results statistics in a dictionary (results_stats_dic) so that it's 
    returned for printing as to help the user to determine the 'best' model for 
    classifying images. Note that the statistics calculated as the results are 
    ...
    Returns:
        results_stats_dic - 
            ...
            (either a percentage or a count)
            where the key is the statistic's name
